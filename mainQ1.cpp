...
void ADC1_Init(void)
{
  ...
  */
    ...
    sConfig.SamplingTime =  ADC_SAMPLETIME_2CYCLES_5;// ADC_SAMPLETIME_2CYCLES_5;//ADC_SAMPLETIME_247CYCLES_5;
...
static void TIM1_Init(void)
{
    ...
    htim1.Init.Period = 100000;// 1000 - 1-998;
